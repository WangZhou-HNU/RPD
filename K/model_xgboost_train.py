...
def optimize_hyperparameters(X_train, y_train, groups_train):
    def objective(trial):
        ...
        gss = GroupShuffleSplit(n_splits=1, test_size=0.2, random_state=47)                             
...
if __name__ == "__main__":
    ...
    train_groups, test_groups = train_test_split(unique_groups, test_size=TEST_SIZE, random_state=25)
